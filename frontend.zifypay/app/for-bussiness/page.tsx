...
import FadeInSection from "../../components/for-bussiness/FadeInSection";
import BusinessStats from "../../components/for-bussiness/BusinessStats";
import Bendo from "../../components/for-bussiness/Bendo";
import Faq from "../../components/for-bussiness/Faq";
import CategoriesMarquee from "../../components/for-bussiness/Marquee";
import Download from "../../components/for-bussiness/Download";
import Footer from "../../components/for-bussiness/Footer";
    ...
    <header className="bg-white shadow-md w-full">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:block">
          ...
          >
            <button className="bg-indigo-700 text-white py-2 px-5 rounded-full text-sm font-semibold hover:bg-indigo-800 transition duration-300">
              BOOK DEMO NOW
            </button>
          </a>
  ...
  return (
    <div>
      ...
      <div style={styles.topSection}>
        <h1 style={{ ...styles.heading }} className="md:text-5xl mt-24">
