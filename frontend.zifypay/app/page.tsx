      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <img src="https://res.cloudinary.com/dt07noodg/image/upload/v1748250920/Group_5_e01ync.png" alt=""  className="w-min h-10"/>
          </div>
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/customer/auth/login" className="text-gray-600 hover:text-blue-600 transition-colors">
