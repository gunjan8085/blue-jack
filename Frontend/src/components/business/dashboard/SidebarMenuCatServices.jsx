...
const menu = [ //TODO: Add all categories and this will be dynamic
  { label: "All Categories", key: "all" },
  { label: "Hair & styling", key: "hair" },
  { label: "Beauty", key: "beauty" },
  { label: "Nail care", key: "nail" },
  { label: "Massage", key: "massage" },
  { label: "Makeup", key: "makeup" },
  { label: "Skincare", key: "skincare" },
  { label: "Hair removal", key: "hair_removal" },
  { label: "Waxing", key: "waxing" },
  { label: "Tanning", key: "tanning" },
  { label: "Haircuts", key: "haircuts" },

];

const SidebarMenuCatServices = ({ selected = "all", onSelect }) => {
  return (
    <div className="tw-w-64 tw-mt-10 tw-border-r tw-min-h-screen">
      <h8 className="tw-text-[18px] tw-text-gray-800 tw-font-bold tw-px-8 tw-py-1">Categories</h8>
...
export default SidebarMenuCatServices;